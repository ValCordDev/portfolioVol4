            ...
            <div className="grid lg:grid-cols-5 grid-cols-1 justify-center items-center">
                <div className="flex flex-col justify-center lg:col-span-2 items-center sm:p-24 p-6 font-sans text-center gap-10 mt-12 lg:mt-0">
                    ...
                    <motion.p 
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                    >
                        For booking, foretrekkes det å kontakte meg gjennom Instagram, men er åpen til å bruke mail. Responstid gjennom mail er litt over 48 timer.
                    </motion.p>
                    <motion.a 
                        href="https://www.instagram.com/devm.media/" 
                        className="border-1 px-20 py-3 rounded-md hover:scale-105 duration-300 shadow-stone-800 shadow-none hover:shadow-2xl font-medium flex justify-center items-center gap-2 flex-row"
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
